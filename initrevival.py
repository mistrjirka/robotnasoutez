...
class Robot:
	def __init__(self, commands = [{"direction":"right", "toDo": [-172, 172], "degreesDelay": 50}, {"direction":"left", "toDo": [172, -172], "degreesDelay": 50}, {"direction":"backward", "toDo": 600 * -1, "degreesDelay": 50}, {"direction":"forward", "toDo": 600, "degreesDelay": 50}], colorS = [{"val": [3,6], "toDo": "forward"}, {"val": [2], "toDo": "right"}, {"val": [5], "toDo": "left"}], motor1 = LM("outC"), motor2 = LM("outB")):
