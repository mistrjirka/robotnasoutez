...
def getColorFromRaw(colorsnsr, colorResponse=[4,5,6,2,3], colorSheet=[[[160,250],[155,270],[45,85]],[[150,1000],[20,43],[15,30]],[[200,1000],[280,1000],[180,1000]],[[20,60],[40,72],[20,1000]], [[15, 30],[90,1000],[13,77]]]):
...
class Robot:
	def __init__(self, commands = [{"direction":"right", "toDo": [-185, 185], "degreesDelay": 150}, {"direction":"left", "toDo": [185, -185], "degreesDelay": 150}, {"direction":"backward", "toDo": 300 * -1, "degreesDelay": 150}, {"direction":"forward", "toDo": 300, "degreesDelay": 150}], colorS = [{"val": [3,6], "toDo": "forward"}, {"val": [2], "toDo": "right"}, {"val": [5], "toDo": "left"}], motor1 = LM("outC"), motor2 = LM("outB")):
