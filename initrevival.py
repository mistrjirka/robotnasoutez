...
class Robot:
	def __init__(self, commands = [{"direction":"right", "toDo": [-180, 180], "degreesDelay": 150}, {"direction":"left", "toDo": [180, -180], "degreesDelay": 150}, {"direction":"backward", "toDo": 300 * -1, "degreesDelay": 150}, {"direction":"forward", "toDo": 300, "degreesDelay": 150}], colorS = [{"val": [3,6], "toDo": "forward"}, {"val": [2], "toDo": "right"}, {"val": [5], "toDo": "left"}], motor1 = LM("outC"), motor2 = LM("outB")):
