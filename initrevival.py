...
def getColorFromRaw(colorsnsr, colorResponse=[4,5,6,2,3], colorSheet=[[[90,200],[126,200],[20,60]],[[123,1000],[20,43],[10,60]],[[150,1000],[230,1000],[150,1000]],[[10,60],[30,100],[10,1000]], [[10, 30],[30,1000],[13,77]]]):
				...
				for j in i["val"]:
					if color == j:
						if color == 3 and self.colorBefore != 3:
							print(self.colorBefore, color,self.greenCounter)
							print("tohle")
